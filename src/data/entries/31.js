...
export default (
  ...
  <div className={'jp'}>
    ...
    <p>まずは、自己紹介の時間です。<br />
    19歳の大学3年生フランス人です。外国語を3ヶ国語勉強しています。子供の頃から日本の文化 <span className="spoiler">ポケモンとかゼルダの伝説とか、しかもあの時は家族がホストファミリーでしたので多くの日本から大学生に出会いました</span>に興味がありました。というわけで、2017年に日本語の勉強を始まりました。<img src={yotsubaSalute} className={'emote'} /> </p>
    ...
    <p>来年はもう一度運転免許証の試験に合格してみたいです。<img src={monkaS} className={'emote'} /> <span className="spoiler">すでに不合格しましたので</span></p>
